<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.expenses.index') }}" 
           ...
           style="color:#5a3e36; border-color:#d8c2b4;">
            Kembali
        </a>
    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-white border-bottom-0 
                        ...
                        <h5 class="mb-0 fw-semibold">Detail Pengeluaran</h5>

                        <button type="button" 
                                wire:click="addDetail"
                                class="btn btn-sm px-3"
                                style="background:#a97458; color:white; border-radius:10px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3 mb-3 rounded-3"
                             style="border:1px solid #eaded3; background:#fff9f4;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select wire:model="details.{{ $index }}.supplier_item_id"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="number"
                                           wire:model="details.{{ $index }}.jumlah"
                                           wire:change="calculateSubtotal({{ $index }})"
                                           class="form-control">
                                </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="number"
                                           wire:model="details.{{ $index }}.subtotal"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="text"
                                           wire:model="details.{{ $index }}.deskripsi"
                                           class="form-control">
                                </div>
                        ...
                        <div class="border-top pt-3 mt-3 d-flex justify-content-between">
                            <h5>Total:</h5>
                            <h5 class="fw-bold" style="color:#a97458;">
                ...
                <button type="submit"
                        ...
                        style="background:#a97458; color:white; border-radius:12px;"
                        wire:loading.attr="disabled">
                    
                    <span wire:loading.remove>
                        <iconify-icon icon="solar:diskette-linear"></iconify-icon>
                        {{ isset($expenseId) ? 'Update' : 'Simpan' }}
                    </span>
